...
class WoMailCheckIn:
    ...
    def write_if_checkin(self,continuousDay):
        ...
        with open(
                    os.path.join(os.path.dirname(os.path.dirname(__file__)), "/home/runner/work/womail/if_checkin.txt"), mode="w",
                    encoding="utf-8"
            ) as f:
    ...
    def read_if_checkin(self):
        ...
        with open(
                    os.path.join(os.path.dirname(os.path.dirname(__file__)), "/home/runner/work/womail/if_checkin.txt"), mode="r",
                    encoding="utf-8"
            ) as f:
                return f.read()
